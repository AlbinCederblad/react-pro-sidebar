...
var ProSidebar = function (_a, ref) {
    var children = _a.children, className = _a.className, width = _a.width, collapsed = _a.collapsed, rtl = _a.rtl, toggled = _a.toggled, image = _a.image, breakPoint = _a.breakPoint, onToggle = _a.onToggle, available = _a.available, rest = __rest(_a, ["children", "className", "width", "collapsed", "rtl", "toggled", "image", "breakPoint", "onToggle", "available"]);
...
var MenuItem = function (_a, ref) {
    var children = _a.children, className = _a.className, icon = _a.icon, active = _a.active, prefix = _a.prefix, suffix = _a.suffix, firstchild = _a.firstchild, popperarrow = _a.popperarrow, id = _a.id, rest = __rest(_a, ["children", "className", "icon", "active", "prefix", "suffix", "firstchild", "popperarrow", "id"]);
    var menuItemRef = ref || React__default.createRef();
    var available = React.useContext(SidebarContext).available;
    function isVisible() {
    ...
    return (React__default.createElement(React__default.Fragment, null, isVisible() ? (React__default.createElement("li", __assign({}, rest, { ref: menuItemRef, className: classnames('pro-menu-item', className, { active: active }) }),
        React__default.createElement("div", { className: "pro-inner-item", tabIndex: 0, role: "button" },
            ...
            suffix ? React__default.createElement("span", { className: "suffix-wrapper" }, suffix) : null))) : (React__default.createElement(React__default.Fragment, null))));
};
...
var SubMenu = function (_a, ref) {
    var children = _a.children, icon = _a.icon, className = _a.className, title = _a.title, _b = _a.defaultOpen, defaultOpen = _b === void 0 ? false : _b, open = _a.open, prefix = _a.prefix, suffix = _a.suffix, firstchild = _a.firstchild, popperarrow = _a.popperarrow, id = _a.id, rest = __rest(_a, ["children", "icon", "className", "title", "defaultOpen", "open", "prefix", "suffix", "firstchild", "popperarrow", "id"]);
    var popperInstance;
    var _c = React.useContext(SidebarContext), collapsed = _c.collapsed, rtl = _c.rtl, toggled = _c.toggled, available = _c.available;
    ...
    var visibleSubMenu = (React__default.createElement("li", { ref: subMenuRef, className: classnames('pro-menu-item pro-sub-menu', className, {
        ...
        firstchild && collapsed ? (React__default.createElement("div", { ref: popperElement, className: classnames('pro-inner-list-item popper-element', {
