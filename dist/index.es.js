...
var MenuItem = function (_a, ref) {
    ...
    var available = useContext(SidebarContext).available;
    function isVisible() {
    ...
    return (React.createElement(React.Fragment, null, isVisible() ? (React.createElement("li", __assign({}, rest, { ref: menuItemRef, className: classnames('pro-menu-item', className, { active: active }) }),
        React.createElement("div", { className: "pro-inner-item", tabIndex: 0, role: "button" },
            ...
            suffix ? React.createElement("span", { className: "suffix-wrapper" }, suffix) : null))) : (React.createElement(React.Fragment, null))));
};
...
var SubMenu = function (_a, ref) {
    ...
    var popperInstance;
    var _c = useContext(SidebarContext), collapsed = _c.collapsed, rtl = _c.rtl, toggled = _c.toggled, available = _c.available;
    ...
    var visibleSubMenu = (React.createElement("li", { ref: subMenuRef, className: classnames('pro-menu-item pro-sub-menu', className, {
        ...
        firstchild && collapsed ? (React.createElement("div", { ref: popperElement, className: classnames('pro-inner-list-item popper-element', {
